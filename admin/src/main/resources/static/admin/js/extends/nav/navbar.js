        ...
        for (var i = 0; i < data.length; i++) {
            ...
            if (data[i].children !== undefined && data[i].children !== null && data[i].children.length > 0) {
                ...
                for (var j = 0; j < data[i].children.length; j++) {
                    ulHtml += '<dd title="' + data[i].children[j].menuName + '">';
                    ulHtml += '<a href="javascript:;" data-url="' + data[i].children[j].menuUrl + '">';
                    ...
                    ulHtml += '<cite>' + '<i class="icon icon-play3 nav-new-cion"></i>' + data[i].children[j].menuName + '</cite>';
                    ulHtml += '</a>';
                    ulHtml += '</dd>';
                }
                ulHtml += '</dl>';
